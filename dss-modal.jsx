    ...
    >
      <div style={{
        ...
        <div style={{ overflowY: 'auto', padding: '24px', flex: 1 }}>
          ...
          {product.method && (
            <div style={{ marginBottom: 20, padding: '14px 16px', background: 'var(--bg-gray)', borderRadius: 10 }}>
              ...
              <p style={{ fontSize: 13, color: 'var(--body)', lineHeight: 1.7 }}>{product.method}</p>
            </div>
          )}
          ...
          {product.chip && (
            <div style={{
              ...
              fontFamily: 'var(--font-mono)', fontSize: 12, marginBottom: 20,
            }}>
              ◎ {product.chip}
            </div>
          )}

          {/* Timeline only (no price) */}
          {product.timeline && (
            <div style={{
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--muted)', letterSpacing: '0.08em', marginBottom: 2 }}>
                  {u.timeline}
                </div>
        ...
        <div style={{ padding: '16px 24px', borderTop: '1px solid var(--border)', display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          ...
          <a href={product.waUrl || 'https://wa.me/628218417551'} target="_blank" rel="noopener"
